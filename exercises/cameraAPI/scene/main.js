...
function setupCamera(val) {
    // your code here
    const camera = new THREE.PerspectiveCamera(cameraParameters.fov,cameraParameters.aspectRatio, cameraParameters.near, cameraParameters.far);
    globalThis.camera = camera;
    camera.position.copy(cameraParameters.eye);
    camera.up.copy(cameraParameters.up);
    camera.lookAt(cameraParameters.at.x, cameraParameters.at.y, cameraParameters.at.z);
    return camera;
